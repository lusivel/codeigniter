        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <form action="<?= base_url('anggota/simpan-data-anggota');?>" method="post">
                        <?= csrf_field(); // Penting untuk keamanan di CodeIgniter 4 ?>

                        <div class="form-group col-md-6">
                            <label>Nama Anggota</label>
                            <input type="text" class="form-control" name="nama_anggota" placeholder="Masukkan Nama Anggota" required="required" value="<?= old('nama_anggota'); ?>">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="no_tlp" placeholder="Masukkan No. Telepon" required="required" value="<?= old('no_tlp'); ?>">
                        ...
                        <div class="form-group col-md-6">
                            <label>Alamat</label>
                            <textarea class="form-control" name="alamat" placeholder="Masukkan Alamat" required="required"><?= old('alamat'); ?></textarea>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="password" class="form-control" name="password_anggota" placeholder="Masukkan Password Anggota" required="required">
