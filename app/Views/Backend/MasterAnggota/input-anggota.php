        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3>Input Anggota</h3>
                    <hr />
                    <form action="<?php echo base_url('anggota/simpan-data-anggota');?>" method="post">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control" name="no_tlp" placeholder="Masukkan No. Telepon" required="required">
                        </div>
                        <div style="clear:both;"></div>
