        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <h3>Input Admin</h3>
                    <hr />
                    <form action="<?php echo base_url('admin/simpan-data-admin');?>" method="post">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            'abcdefghijklmnopqrstuvwqyz_ABCDEFGHIJKLMNOPQRSTUVWQYZ1234567890',this)" name="username" placeholder="Masukkan Username Admin" required="required">
                        </div>
                        <div style="clear:both;"></div>

                        <div class="form-group col-md-6">
                            <label>Akses Level</label>
                            <select class="form-control" name="level" placeholder="Masukkan Nama Admin" required="required">
